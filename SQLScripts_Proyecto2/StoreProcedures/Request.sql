...
GO
CREATE PROCEDURE APSP_InsertRequest(@FK_LotXCycle INT,  @FK_ActivityType VARCHAR(50), @RequestType VARCHAR(50), @Date DATETIME, @Description VARCHAR(150), @Request VARCHAR(50), @Amount FLOAT, @State INT)
AS
BEGIN
	BEGIN TRY
